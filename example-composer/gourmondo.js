const gourmondo = {
    ...
    "require": {
        ...
        "ext-readline": "*",
        "ext-redis": "*",
        "akeneo/api-php-client": "3.0.0 as 1.0.1",
        "akeneo/api-php-client-ee": "3.0.0 as 1.0.0",
        "cocur/slugify": "^3.1",
        "league/flysystem-sftp": "^1.0",
        "mattketmo/email-checker": "^1.5",
        "rtheunissen/guzzle-rate-limiter": "^2.0",
        "spryker-eco/adyen": "^1.0",
        "spryker-eco/adyen-api": "^1.0",
        "spryker-eco/akeneo-pim-middleware-connector": "^1.0",
        "spryker-eco/amazon-pay": "^2.0",
        ...
        "spryker-middleware/process": "^1.1",
        "spryker-middleware/report": "^1.1",
